...
4. The `virtion-attending` Managed Agent surfaces a `render_triage_badge` card in real time (15 s) — this is the most valuable shot, it demonstrates Managed Agents + custom tools + Opus 4.7 in one frame.

---
name: virtion-interview
description: Interview the developer before building a feature or sharpening the hackathon pitch. Use when the user says "/virtion-interview", has a vague goal, or when the request could be interpreted two or more ways. Do NOT use for concrete bug fixes or typo-level edits.
---

# Virtion — interview skill

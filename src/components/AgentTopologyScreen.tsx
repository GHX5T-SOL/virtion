...
//
// Top-down map of the virtion-attending Managed Agent (Opus 4.7) and the
...
const SUB_RULES: ChildNode[] = [
  ...
  },
  {
    ...
    details: {
      ...
      files: ['src/data/polyclinicPatients.ts', '.claude/skills/virtion-rubric-author/'],
      bullets: [
...
const SESSIONS: ChildNode[] = [
  {
    id: 'sess-attending',
    side: 'right',
    title: 'virtion-attending · grading',
  ...
  },
  {
    ...
    details: {
      ...
      meta: [{ label: 'Path', value: '.claude/skills/virtion-rubric-author/' }],
  ...
  },
  {
    ...
    details: {
      ...
      meta: [
        { label: 'Path', value: '.claude/skills/virtion-guideline-curator/' },
  ...
  },
  {
    id: 'sess-verify',
    side: 'right',
    title: 'virtion-verify-simulation',
    ...
    details: {
      ...
      meta: [
        { label: 'Path', value: '.claude/skills/virtion-verify-simulation.md' },
...
export function AgentTopologyScreen() {
  ...
  const selected = useMemo(() => {
    ...
    if (selectedId === 'hub') {
      return {
        title: 'Opus 4.7 — virtion-attending Managed Agent',
        badge: 'MANAGED AGENT',
        color: 'var(--peach)',
        deep: 'var(--peach-deep)',
        details: HUB_DETAILS,
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 32, fontWeight: 900, color: 'var(--ink)' }}>
              Opus 4.7 — virtion-attending Managed Agent
            </div>

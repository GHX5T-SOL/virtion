// Custom tools exposed to the `virtion-attending` Managed Agent.
//
// The agent-side tool definitions live in `backend/server.py` as
// `VIRTION_CUSTOM_TOOLS` (JSON Schema, sent to `agents.create`). This file is
...
//
// If you change a schema here, update `VIRTION_CUSTOM_TOOLS` in
